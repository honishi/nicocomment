    ...
    @pytest.mark.parametrize(("input", "expected"), [
        ((u"co12345", "msg103.live.nicovideo.jp", 2808, 1314071859),    # input
         [("msg103.live.nicovideo.jp", 2808, 1314071859),               # expected
          ...
          ("msg103.live.nicovideo.jp", 2812, 1314071863),
          ("msg103.live.nicovideo.jp", 2813, 1314071864),
          ("msg103.live.nicovideo.jp", 2814, 1314071865),
          ("msg104.live.nicovideo.jp", 2805, 1314071866)]),
        ...
        ((u"立ち見A列", "msg103.live.nicovideo.jp", 2805, 1314071859),
         [("msg102.live.nicovideo.jp", 2814, 1314071858),
          ...
          ("msg103.live.nicovideo.jp", 2808, 1314071862),
          ("msg103.live.nicovideo.jp", 2809, 1314071863),
          ("msg103.live.nicovideo.jp", 2810, 1314071864),
          ("msg103.live.nicovideo.jp", 2811, 1314071865)]),
        ...
        ((u"ch12345", "omsg101.live.nicovideo.jp", 2815, 1314071859),
         [("omsg101.live.nicovideo.jp", 2815, 1314071859),
          ...
          ("omsg102.live.nicovideo.jp", 2816, 1314071864)]),
        ((u"ch12345", "omsg104.live.nicovideo.jp", 2815, 1314071859),
         [("omsg104.live.nicovideo.jp", 2815, 1314071859),
          ...
          ("omsg104.live.nicovideo.jp", 2816, 1314071863),
        ...
        ((u"立ち見B列", "omsg103.live.nicovideo.jp", 2817, 1314071859),
         [("omsg101.live.nicovideo.jp", 2817, 1314071857),
          ("omsg102.live.nicovideo.jp", 2817, 1314071858),
          ("omsg103.live.nicovideo.jp", 2817, 1314071859),
          ("omsg104.live.nicovideo.jp", 2817, 1314071860),
          ("omsg105.live.nicovideo.jp", 2867, 1314071861),
          ("omsg106.live.nicovideo.jp", 2880, 1314071862)]),
