    ...
    @pytest.mark.parametrize(("input", "expected"), [
        ((u"co12345", "msg103.live.nicovideo.jp", 2828, 1314071859),    # input
         [("msg103.live.nicovideo.jp", 2828, 1314071859),               # expected
          ("msg103.live.nicovideo.jp", 2829, 1314071860),
          ("msg103.live.nicovideo.jp", 2830, 1314071861),
          ("msg103.live.nicovideo.jp", 2831, 1314071862),
          ("msg103.live.nicovideo.jp", 2832, 1314071863),
          ("msg103.live.nicovideo.jp", 2833, 1314071864),
          ("msg103.live.nicovideo.jp", 2834, 1314071865),
          ("msg104.live.nicovideo.jp", 2835, 1314071866)]),
        ((u"立ち見A列", "msg103.live.nicovideo.jp", 2828, 1314071859),
         [("msg103.live.nicovideo.jp", 2827, 1314071858),
        ...
        ((u"立ち見A列", "msg103.live.nicovideo.jp", 2825, 1314071859),
         [("msg102.live.nicovideo.jp", 2824, 1314071858),
          ("msg103.live.nicovideo.jp", 2825, 1314071859),
          ("msg103.live.nicovideo.jp", 2826, 1314071860),
          ("msg103.live.nicovideo.jp", 2827, 1314071861),
          ("msg103.live.nicovideo.jp", 2828, 1314071862),
          ("msg103.live.nicovideo.jp", 2829, 1314071863),
          ("msg103.live.nicovideo.jp", 2830, 1314071864),
          ("msg103.live.nicovideo.jp", 2831, 1314071865)]),
        ((u"立ち見A列", "msg101.live.nicovideo.jp", 2805, 1314071859),
         [("msg105.live.nicovideo.jp", 2854, 1314071858),
          ...
          ("msg101.live.nicovideo.jp", 2808, 1314071862),
          ("msg101.live.nicovideo.jp", 2809, 1314071863),
          ("msg101.live.nicovideo.jp", 2810, 1314071864),
          ("msg101.live.nicovideo.jp", 2811, 1314071865)]),
        ((u"立ち見B列", "msg101.live.nicovideo.jp", 2805, 1314071859),
         [("msg105.live.nicovideo.jp", 2853, 1314071857),
          ("msg105.live.nicovideo.jp", 2854, 1314071858),
          ("msg101.live.nicovideo.jp", 2805, 1314071859),
          ("msg101.live.nicovideo.jp", 2806, 1314071860),
          ("msg101.live.nicovideo.jp", 2807, 1314071861),
        ...
        ((u"立ち見C列", "msg101.live.nicovideo.jp", 2805, 1314071859),
         [("msg105.live.nicovideo.jp", 2852, 1314071856),
          ("msg105.live.nicovideo.jp", 2853, 1314071857),
          ("msg105.live.nicovideo.jp", 2854, 1314071858),
          ("msg101.live.nicovideo.jp", 2805, 1314071859),
          ("msg101.live.nicovideo.jp", 2806, 1314071860),
        ...
        ((u"ch12345", "omsg101.live.nicovideo.jp", 2815, 1314071859),
         [("omsg101.live.nicovideo.jp", 2815, 1314071859),
          ...
          ("omsg101.live.nicovideo.jp", 2816, 1314071863),
          ("omsg102.live.nicovideo.jp", 2829, 1314071864)]),
        ((u"ch12345", "omsg104.live.nicovideo.jp", 2854, 1314071859),
         [("omsg104.live.nicovideo.jp", 2854, 1314071859),
          ...
          ("omsg102.live.nicovideo.jp", 2829, 1314071861),
          ("omsg103.live.nicovideo.jp", 2842, 1314071862),
          ("omsg104.live.nicovideo.jp", 2855, 1314071863),
          ("omsg101.live.nicovideo.jp", 2817, 1314071864)]),
        ((u"ch12345", "omsg103.live.nicovideo.jp", 2843, 1314071859),
         [("omsg103.live.nicovideo.jp", 2843, 1314071859),
          ...
          ("omsg105.live.nicovideo.jp", 2867, 1314071861),
          ("omsg106.live.nicovideo.jp", 2880, 1314071862),
          ("omsg105.live.nicovideo.jp", 2868, 1314071863),
          ("omsg106.live.nicovideo.jp", 2881, 1314071864)]),
