    ...
    @pytest.mark.parametrize(("input", "expected"), [
        ((u"co12345", "msg103.live.nicovideo.jp", 2828, 1314071859),    # input
         [("msg103.live.nicovideo.jp", 2828, 1314071859),               # expected
          ...
          ("msg101.live.nicovideo.jp", 2809, 1314071861),
          ("msg102.live.nicovideo.jp", 2819, 1314071862),
          ("msg103.live.nicovideo.jp", 2829, 1314071863),
          ("msg104.live.nicovideo.jp", 2839, 1314071864),
          ("msg101.live.nicovideo.jp", 2810, 1314071865),
          ("msg102.live.nicovideo.jp", 2820, 1314071866)]),
        ...
        ((u"立ち見A列", "msg103.live.nicovideo.jp", 2825, 1314071859),
         [("msg102.live.nicovideo.jp", 2815, 1314071858),
          ...
          ("msg101.live.nicovideo.jp", 2806, 1314071861),
          ("msg102.live.nicovideo.jp", 2816, 1314071862),
          ("msg103.live.nicovideo.jp", 2826, 1314071863),
          ("msg104.live.nicovideo.jp", 2836, 1314071864),
          ("msg101.live.nicovideo.jp", 2807, 1314071865)]),
        ((u"立ち見A列", "msg101.live.nicovideo.jp", 2805, 1314071859),
         [("msg104.live.nicovideo.jp", 2844, 1314071858),
          ...
          ("msg101.live.nicovideo.jp", 2806, 1314071863),
          ("msg102.live.nicovideo.jp", 2816, 1314071864),
          ("msg103.live.nicovideo.jp", 2826, 1314071865)]),
        ((u"立ち見B列", "msg101.live.nicovideo.jp", 2805, 1314071859),
         [("msg103.live.nicovideo.jp", 2834, 1314071857),
          ("msg104.live.nicovideo.jp", 2844, 1314071858),
          ("msg101.live.nicovideo.jp", 2805, 1314071859),
          ("msg102.live.nicovideo.jp", 2815, 1314071860),
          ("msg103.live.nicovideo.jp", 2825, 1314071861),
        ...
        ((u"立ち見C列", "msg101.live.nicovideo.jp", 2805, 1314071859),
         [("msg102.live.nicovideo.jp", 2824, 1314071856),
          ("msg103.live.nicovideo.jp", 2834, 1314071857),
          ("msg104.live.nicovideo.jp", 2844, 1314071858),
          ("msg101.live.nicovideo.jp", 2805, 1314071859),
          ("msg102.live.nicovideo.jp", 2815, 1314071860),
